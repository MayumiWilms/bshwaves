function [bag] = dqc_seastate_realtime_v2_6_tmc_waves5_from_to(incoming_folder, work_folder, outgoing_folder, log_folder, sensor, station, date_from, date_to, config_output) 
...
% DQC for DWR with Waves5 (timestamps are xx:00 and xx:30 for hiw/his/gps)
